...
<body>
    <div class="container">
        ...
        <div class="bg-dark bg-opacity-50">
            <h2 class="text-center text-white pt-5">An Overview of Our Product</h2>
            <div class="row m-auto gap-3 p-3 pt-0">
                <div class="col border border-3 shadow p-4 text-center bg-white">
